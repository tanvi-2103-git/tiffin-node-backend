...
adminRoutes.put("/approveRetailer/:retailerid",validateToken,RoleBaseValidation("approve_retailer_request"), adminController.approveRetailer);
adminRoutes.put("/rejectRetailer/:retailerid",validateToken,RoleBaseValidation("reject_retailer_request"), adminController.rejectRetailer);
adminRoutes.put("/makeretailertrendy/:retailerid",validateToken,RoleBaseValidation("reject_retailer_request"), adminController.makeRetailerTrendy);

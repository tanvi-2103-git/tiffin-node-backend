...
export class CartController {
    ...
    //         let customercart  =  await CartModel.findOne({ customer_id: customer_id });
    ...
    //         }else if (customercart && !cart) {
    //             res.status(404).json({statuscode:404,message:"you can add tiffin from single retailer only"})
    //         }else{
